...
export default function DemanderUnDevisPage({
  ...
  return (
    <>
      <PageHero kicker={q.kicker} title={q.title} subtitle={q.subtitle} />
            ...
            <Reveal delay={80}>
              <div className="card rounded-xl border-white/10 p-6">
                ...
                <div className="mt-5 flex flex-col gap-2.5">
                  <Link href={`/${locale}/faq`} className="btn-outline-accent btn-md w-full justify-between">
                    <span>{q.helpFaq}</span>
                    <ArrowRightIcon className="h-4 w-4 rtl:rotate-180" />
                  </Link>
                  <Link href={`/${locale}/contact`} className="btn-outline btn-md w-full justify-between">
                    <span>{q.helpContact}</span>
                    <ArrowRightIcon className="h-4 w-4 rtl:rotate-180" />
                  </Link>
                  <a
